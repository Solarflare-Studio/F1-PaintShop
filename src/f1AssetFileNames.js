...
class F1AssetFileNames {
    ...
    constructor() {
        ...
        this.car_files = [ './assets/car/F1PS_F1_Car_V11_Rev3.glb',            // 3d model glb
                            ...
                            './assets/car/01_StaticMainMaps/V11/2k/F1PS_Car_Static_V11_BaseColor_lite.jpg',      // static base map always stays the same
